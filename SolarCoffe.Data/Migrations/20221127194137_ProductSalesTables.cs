...
{
    public partial class ProductSalesTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductInventirySnapshots",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInventirySnapshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductInventirySnapshots_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInventirySnapshots_ProductId",
                table: "ProductInventirySnapshots",
                column: "ProductId");
